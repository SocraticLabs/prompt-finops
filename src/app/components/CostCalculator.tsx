...
function IntegratedCostCalculator() {
  ...
  const calculateCosts = () => {
    ...
    const totalCost = costPerCall * apiCalls;
    ...
    return {
      ...
      outputCost,
      costPerCall,
      totalCost: totalCost * timeframeMultiplier,
      tokenUtilization:
  ...
  return (
    <div className="space-y-8">
      {/* Token Counter and Analyzer Section */}
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1">
                Input Tokens {tokenResult && "(Auto-populated from tokenizer)"}
              </label>
          ...
          <div className="mt-6">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5">
              <div
                ...
                style={{ width: `${Math.min(costs.tokenUtilization, 100)}%` }}
              ></div>
            </div>
            <p className="text-sm mt-1">
              {costs.tokenUtilization.toFixed(1)}% of context window
            </p>
          </div>

          {tokenResult && (
            <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900 rounded-lg">
              <h4 className="font-medium mb-2">Token Efficiency Metrics</h4>
...
export default function IntegratedCostAnalytics() {
  return (
    <div className="max-w-7xl mx-auto p-6">
      <h1 className="text-4xl font-bold mb-6">LLM Cost Analytics</h1>
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        Analyze tokenization and estimate costs across different LLM models.
      </p>
      <IntegratedCostCalculator />
    </div>
  );
}
